...
const CardNewsletter = (props) => {
  ...
  // todo эта форма должна быть видна только если пользователь залогинен,
  // так как только залогиненеый пользователь может себя подписать на рассылку
  // иначе атака ботов пос положит
